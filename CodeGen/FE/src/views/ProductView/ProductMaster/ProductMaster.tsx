...
function ProductMaster() {
    ...
    () => {
      return [
              ...
              <>
               {
                ...
                && productImageMappings.map((productImageMapping, index)=>{
                    return (
                     <img key={index} src={productImageMapping?.image?.url} width="40" height="40" alt=""/>
                    );
                },
                )
              }
        ...
        },
        {
          ...
          ellipsis: true,
          render(
            productProductGroupingMappings: ProductProductGroupingMapping,
          ) {
            return (
              <>
  ...
  //     key: nameof(previewModel.items[0].name),
  //     dataIndex: nameof(previewModel.items[0].name),
  //     align: 'center',
  //   },
  //   {
  //     title: translate('items.code'),
  //     key: nameof(previewModel.items[0].code),
  //     dataIndex: nameof(previewModel.items[0].code),
  //     align: 'center',
  //   },
  //   {
  //     title: translate('items.scanCode'),
  //     key: nameof(previewModel.items[0].scanCode),
  //     dataIndex: nameof(previewModel.items[0].scanCode),
  //     align: 'center',
  //   },
  //   {
  //     title: translate('items.price'),
  //     key: nameof(previewModel.items[0].price),
  //     dataIndex: nameof(previewModel.items[0].price),
  //     align: 'center',
  //   },
  //   {
  //     title: translate('items.retailPrice'),
  //     key: nameof(previewModel.items[0].retailPrice),
  //     dataIndex: nameof(previewModel.items[0].retailPrice),
  //     align: 'center',
  //   },
  // ];
              ...
              <Col className="pl-1" span={6}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    getList={productRepository.normalListProductGrouping}
